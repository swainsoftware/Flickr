	...
	.done(function(data) {								// when done - call
		...
		$.each( data.items, function(i,item) {
			...
			if (testForDubs == -1) {					// if not duplicate, then
				...
				fullImgSrc = imgSource.replace('_m.jpg','_z.jpg');	// create a link to full image
				var divId = 'div' + imgId;				// id for new div
				
				divString = '<div data-role="popup" id="' + divId + '" data-overlay-theme="b" data-theme="b" data-corners="false" data-position-to="window">'+
				'<a href="#" data-rel="back" class="ui-btn ui-corner-all ui-shadow ui-btn-a ui-icon-delete ui-btn-icon-notext ui-btn-right">Close</a>'+
				'<img class="popphoto" src="' + fullImgSrc + '">'+
				'</div>';
